...
{
private:
    void static check_precondition(Space& space_1, Space& space_2)
    {
        if(space_1 != Space::H_1 || space_2 != Space::H_1)
        {
...
private:
    void static check_precondition(Space& space_1, Space& space_2)
    {
        if(space_1 != Space::H_curl || space_2 != Space::H_curl)
        {
...
private:
    void static check_precondition(Space& space_1, Space& space_2)
    {
        if((space_1 != Space::H_curl || space_2 != Space::H_curl) && (space_1 != Space::H_div || space_2 != Space::H_div) )
        {
...
private:
    void static check_precondition(Space& space_1, Space& space_2)
    {
        if((space_1 != Space::H_curl || space_2 != Space::H_1) && (space_1 != Space::H_div || space_2 != Space::H_1) )
        {
...
private:
    void static check_precondition(Space& space_1, Space& space_2)
    {
        if((space_1 != Space::H_1 || space_2 != Space::H_curl) && (space_1 != Space::H_1 || space_2 != Space::H_div) )
        {

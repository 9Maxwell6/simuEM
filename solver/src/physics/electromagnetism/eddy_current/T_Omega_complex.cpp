...
bool T_Omega_c::assemble_pc()
{
    ...
    Mat P11, P12, P21, P22;
    PetscCall(MatPtAP(Mc_c_.mat,pc_P_.mat,MAT_INITIAL_MATRIX, PETSC_DEFAULT, &P11));
    PetscCall(MatPtAP(Kc_c_.mat,pc_P_.mat,MAT_INITIAL_MATRIX, PETSC_DEFAULT, &P12));
    PetscCall(MatPtAP(Kc_r_.mat,pc_P_.mat,MAT_INITIAL_MATRIX, PETSC_DEFAULT, &P21));
    PetscCall(MatPtAP(Mc_r_.mat,pc_P_.mat,MAT_INITIAL_MATRIX, PETSC_DEFAULT, &P22));
...
bool T_Omega_c::solve_pc_system()
{
    ...
    if(pc_alg_ == 1){
        ...
        PetscCall(T_Omega_AMS_c::solve_AMS(
            ...
            pc_Qc_.mat, pc_Qi_.mat, NULL, NULL, 
